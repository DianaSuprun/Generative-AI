...
class TutorChatbot:
    ...
    # Function that counts how much it past before last question - FULLY DONE
    def timeout_decorator(self, timeout_minutes):
        def decorator(func):
            def wrapper(*args, **kwargs):
                ...
                if elapsed_time > timeout_minutes * 60:
                    ...
                    respose_tokens = TutorChatbot.clarifiing()
                    return self.algoritgm_responses('yes', 'no', respose_tokens)
                return result
            return wrapper
        return decorator

        # Function to communicate with fine-tuned Chat GPT - FULLY DONE
        @timeout_decorator(3)
        ...
        # Function to star a communication with fine-tuned Chat GPT
        ...
        # 2 step: clarifying if everything was understandeble
        def clarifiing(self):
        ...
        # 3 step: work with answer. May use in another functions
